...
set object 25 rect from 71.5,36 to 76.5,36.2 fc rgb "red" fs noborder
set object 26 rect from 119.5,36 to 124.5,36.2 fc rgb "red" fs noborder
set object 27 rect from 38.5,36.8 to 48.5,37 fc rgb "blue" fs noborder
...
set object 30 rect from 48.5,36 to 71.5,37 fc rgb "white"
set object 31 rect from 76.5,36 to 96.5,37 fc rgb "grey" fs noborder
...
set object 34 rect from 69.5,39 to 77.5,39.2 fc rgb "red" fs noborder
set object 35 rect from 40.5,39.8 to 47.5,40 fc rgb "blue" fs noborder
set object 36 rect from 110.5,39.8 to 124.5,40 fc rgb "blue" fs noborder
set object 37 rect from 19.5,39 to 40.5,40 fc rgb "grey" fs noborder
set object 38 rect from 47.5,39 to 69.5,40 fc rgb "white"
set object 39 rect from 77.5,39 to 110.5,40 fc rgb "grey" fs noborder
...
set object 50 rect from 69.5,45 to 76.5,45.2 fc rgb "red" fs noborder
set object 51 rect from 119.5,45 to 124.5,45.2 fc rgb "red" fs noborder
set object 52 rect from 38.5,45.8 to 48.5,46 fc rgb "blue" fs noborder
...
set object 55 rect from 48.5,45 to 69.5,46 fc rgb "white"
