...
set object 6 rect from 0.5,30 to 14.5,30.2 fc rgb "red" fs noborder
set object 7 rect from 35.5,30.8 to 307.5,31 fc rgb "blue" fs noborder
set object 8 rect from 14.5,30 to 35.5,31 fc rgb "grey" fs noborder
set object 9 rect from 0.5,33 to 12.5,33.2 fc rgb "red" fs noborder
set object 10 rect from 33.5,33.8 to 307.5,34 fc rgb "blue" fs noborder
set object 11 rect from 12.5,33 to 33.5,34 fc rgb "grey" fs noborder
set object 12 rect from 29.5,36.8 to 307.5,37 fc rgb "blue" fs noborder
set object 13 rect from 0.5,36 to 29.5,37 fc rgb "black" fs noborder
set object 14 rect from 29.5,39.8 to 307.5,40 fc rgb "blue" fs noborder
set object 15 rect from 0.5,39 to 29.5,40 fc rgb "black" fs noborder
set object 16 rect from 0.5,42 to 14.5,42.2 fc rgb "red" fs noborder
set object 17 rect from 35.5,42.8 to 307.5,43 fc rgb "blue" fs noborder
set object 18 rect from 14.5,42 to 35.5,43 fc rgb "grey" fs noborder
set object 19 rect from 30.5,45.8 to 307.5,46 fc rgb "blue" fs noborder
set object 20 rect from 0.5,45 to 30.5,46 fc rgb "black" fs noborder
